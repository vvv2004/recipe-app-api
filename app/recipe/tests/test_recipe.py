...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recipe_existing_tags(self):
        ...
        )  # Check if existing tag is in new recipe
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning an existing recipe tag when updating a recipe"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test creating recipes by adding new ingredients"""
        payload = {
    ...
    def test_create_ingredient_oon_update(self):
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        initial_ingredient = Ingredient.objects.create(user=self.user, name="Pepper")
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(initial_ingredient)
        ...
        self.assertNotIn(initial_ingredient, ingredients)
    ...
    def test_clear_recipe_ingredients(self):
        ...
        self.assertEqual(ingredients_count, 0)
